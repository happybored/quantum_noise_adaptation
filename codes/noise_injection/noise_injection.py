...
def main(train_noise_model,test_noise_model,backend):
    ...
    acc = valid_test(dataflow, 'test', model, device, qiskit=True)
    return acc
...
if __name__ == '__main__':
    ...
    path = 'calibration_data/experiment-data-ibmq_belem_train_on_diff_noise.csv'
    ...
    for i in range(1,len(df)):
        ...
        acc = main(train_noise_model,test_property_model,backend)
