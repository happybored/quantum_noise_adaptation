...
def main(train_noise_model,test_noise_model,backend,time,pruning_rate =None):
    ...
    torch.save(best_model,'database/noise_injection/date{}_pr{}_acc{}'.format(time,admm_args.prune_ratio,acc))
    result =  dict()
...
if __name__ == '__main__':
    ...
    for i in range(0,len(df2)):
        ...
        result = main(test_property_model,test_property_model,backend,df2['timestamp'].loc[i],pruning_rate=pruning_rate)
