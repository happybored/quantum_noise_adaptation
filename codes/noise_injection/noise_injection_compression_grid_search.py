...
def main(train_noise_model,test_noise_model,backend,time):
    ...
    torch.save(best_model,'dynamic_model/noise_injection/date{}_pr{}_acc{}'.format(time,admm_args.prune_ratio,acc))
    result =  dict()
...
if __name__ == '__main__':
    ...
    for i in range(0,len(df2)):
        ...
        result = main(test_property_model,test_property_model,backend,df2['timestamp'].loc[i])
