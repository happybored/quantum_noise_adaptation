...
database_data_path = 'calibration_data/cluster_res_eq/ibmq_belem-tech-offline-cluster-database.xlsx'
online_data_path = 'calibration_data/cluster_res_eq/ibmq_belem-tech-online.xlsx'
online_res_path = 'calibration_data/cluster_res_eq/ibmq_belem-tech-offline-online-eq.xlsx'
...
for i in range(len(online_df)):
    ...
    if min_center == '' or min_dis > cluster_centers_noise[min_center] *2:
