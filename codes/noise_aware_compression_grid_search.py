...
#set noise model
    ...
    torch.save(best_model,'dynamic_model/{}/date{}_pr{}_acc{}'.format(args.pruning_type,timestamp,admm_args.prune_ratio,acc))
    result =  dict()
...
if __name__ == '__main__':
    ...
    sys.stdout = Logger('./logger/{}_log.txt'.format('noise_aware_grid_search_mnist'))
    import datetime    
    ##load csv 
    from qiskit import IBMQ
