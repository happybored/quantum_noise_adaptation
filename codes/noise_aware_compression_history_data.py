...
#set noise model
    ...
    if train_flag:
        ...
        torch.save(best_model,'database/{}/{}.pth'.format(args.pruning_type,time))
    else:
        pass
...
if __name__ == '__main__':
    ...
    for i in range(0,len(df2)):
        ...
        result = main(test_property_model,test_property_model,backend,df2['timestamp'].loc[i],qubit_noise = qubit_noise,pruning_rate=pruning_rate)
