...
#set noise model
    ...
    if train_flag:
        ...
        torch.save(best_model,'database_iris_jakarta/{}/{}.pth'.format(args.pruning_type,time))
    else:
        print(center_model)
        model = torch.load('database_iris_jakarta/{}/{}.pth'.format(args.pruning_type,center_model))
