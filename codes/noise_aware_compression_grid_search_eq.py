...
#set noise model
    ...
    torch.save(best_model,'dynamic_model_eq/{}/date{}_pr{}_acc{}'.format(args.pruning_type,timestamp,admm_args.prune_ratio,acc))
    result =  dict()
...
if __name__ == '__main__':
    ...
    fname = 'calibration_data/prune_records_eq.xlsx'  
    # df = pd.read_csv(path)
