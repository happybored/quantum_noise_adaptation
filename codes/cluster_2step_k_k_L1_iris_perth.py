...
path ='calibration_data/cluster_res_iris_perth/ibmq_perth-tech-offline.xlsx'
online_path = 'calibration_data/cluster_res_iris_perth/ibmq_perth-tech-online.xlsx'
online_res_path = 'calibration_data/cluster_res_iris_perth/ibmq_perth-tech-online-dis.xlsx'
cluster_name = 'k_k_L1'
cluster_info_path = 'calibration_data/cluster_res_iris_perth/ibmq_perth-tech-offline-cluster-{}-info.xlsx'.format(cluster_name)
cluster_res_path = 'calibration_data/cluster_res_iris_perth/ibmq_perth-tech-offline-cluster-{}-result.xlsx'.format(cluster_name)
